                ...
                if (!empty($result)) {
                    foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success" name="edit" id="edit" href="edit_matkul.php?id=<?= $data->kodemk ?>">EDIT</a>
                                <a class="btn btn-danger" name="delete" id="delete" href="proces.php?id=<?= $data->kodemk ?>">DELETE</a>
                            </td>
                        </tr>
                    <?php endforeach;
                } else { ?>
